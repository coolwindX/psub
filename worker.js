...
var src_default = {
  async fetch(request, env) {
    ...
    const frontendUrl = 'https://raw.githubusercontent.com/coolwindX/psub/main/frontend_new.html';
    ...
    if (pathSegments.length === 0) {
      ...
      const modifiedHtml = originalHtml.replace(/https:\/\/blog\.coolwind\.top/, host);
